            ...
            <ul className="flex flex-row items-center justify-center gap-2 flex-wrap max-w-[400px] list-none p-0 m-0">
                {searches.map((term) => (
                    <li
                        ...
                        className="px-2 py-1 border border-gray-300 rounded cursor-pointer text-sm font-normal text-white bg-black mb-5 hover:bg-gray-800 transition-colors duration-300"
                    >
                        {term}
                    </li>
                ))}
